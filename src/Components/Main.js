...
let ListItems = React.createClass({  //Creating List of the items
    ...
    render: function() {
        return ( //creating both a il with class name list-menu and looping through the items and creating creating a li for each and passing it into the ul.
...
//assemlbing all the lines in the footer
